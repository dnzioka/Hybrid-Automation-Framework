...
public class SubmitOrderTest extends BaseTest {
	...
	public Object[][] getData() throws IOException {
		 ...
		 * "testingwdg17@gmail.com"); map.put("password", "Olivo2019");
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				System.getProperty("user.dir") + "//src//test//java//toqio//data//PurchaseOrder.json");
	...
	// return new Object [][] {{"testingwdg17@gmail.com","Olivo2019","ADIDAS
	// ORIGINAL"},{"anshika@gmail.com","Iamking@000","IPHONE 13 PRO"}};
	// }
